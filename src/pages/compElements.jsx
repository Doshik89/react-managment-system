...
const CompElements = () => {
	const [gridData, setGridData] = useState([
		{
			...
			elemParent: 1,
			status: 'Accepted',
			elemArrival: '12 April',
			elemDeletion: '13 April',
		},
		{
			id: 2,
			elemParent: 2,
	...
	const columns = [
		...
		},
		{
			...
			dataIndex: 'elemArrival',
			align: 'center',
		},
		{
			title: 'Дата снятия',
			dataIndex: 'elemDeletion',
			align: 'center',
		},
		{
			title: 'Action',
