...
const CatalogWorkplaces = () => {
	...
	return (
		<div>
			...
			>
				<h1 style={{ marginLeft: 20, marginTop: 30 }}>Каталог рабочих мест</h1>
				<Button
					style={{
						marginTop: 15,
						marginRight: 30,
...
export default CatalogWorkplaces;
